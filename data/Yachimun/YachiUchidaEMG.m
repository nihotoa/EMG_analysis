...
%file info
monkeyname = 'Ya' ; 
xpdate = '170907'; %testtest(j,3:8) % yymmdd   xpdate='150604' ; %
file_num = [2,4];
...
rangeF_ms = 300; %how long do you want to see former part of trigger[msec] 
rangeL_ms = 300; %how long do you want to see latter part of trigger[msec]
...
%     SUC_num = 142;
    ...
    for j = 1:EMG_num   
        ...
        plot([Tim_range_ave_alt(1) Tim_range_ave_alt(1)],[0 100],'y');
        hold on;
        plot([Tim_range_ave_alt(1)+Tim_range_ave_alt(2)-1*1000/SampleRate Tim_range_ave_alt(1)+Tim_range_ave_alt(2)-1*1000/SampleRate],[0 1000],'y');
        hold on;
