...
%         disp(['yplease select all Pdata generated by MakeDataPlot_H_utb(' realname ' -> nmf_result -> synData¨YaSyn4~_Pdata.mat)z'])
        disp(['yplease select all Pdata.mat(location: monkey_name -> easyData -> P-DATA)z'])
...
if plot_fig == 1
    ...
    %figure(plot Pall Data(ƒ^ƒXƒNŠJŽn‚©‚ç-25% - 105%‚Ì})); %ƒvƒƒbƒg‚µ‚½ƒf[ƒ^‚ð•Û‘¶‚à‚¹‚¸‚Éclose all‚µ‚Ä‚¢‚é.‰½‚ð‚µ‚½‚©‚Á‚½‚Ì‚©•s–¾
...
if save_xcorr_data == 1
    save_fold = 'easyData/P-DATA(TTakei-filter)/'; %ƒtƒ@ƒCƒ‹‚ðƒZ[ƒu‚·‚éêŠ
