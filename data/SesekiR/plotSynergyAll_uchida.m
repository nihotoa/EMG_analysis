        ...
        for i=1:SUC_num
           ...
           elseif time_w<TIME_W 
               ...
               %竊灘撫鬘後?ｮ陦?
                   ...
                   pullData(i,:) = resample(All_T(j,SUC_Timing_A(i,1):SUC_Timing_A(i,4)),TIME_W,time_w);
                   pre_term1(i,:) = resample(All_T(j,SUC_Timing_A(i,1)-50/(TIME_W/time_w):SUC_Timing_A(i,1)-1),TIME_W,time_w); %正規化した後に、タスクスタート前50フレーム分を抽出する
               end
           end
