...
for i=1:length(whichfiles)
    ...
    if exist('CTTL_049_Up')
        item1_on=[item1_on CTTL_049_Up+CTTL_049_TimeBegin*TTL_SampleRate] ;
        item1_off=[item1_off CTTL_049_Down+CTTL_049_TimeBegin*TTL_SampleRate] ;
    end
    if exist('CTTL_050_Up')
        item2_on=[item2_on CTTL_050_Up+CTTL_050_TimeBegin*TTL_SampleRate] ;
        item2_off=[item2_off CTTL_050_Down+CTTL_050_TimeBegin*TTL_SampleRate] ;
    end

        
    allfiles(i,:)=filename ;
    
    clear CTTL* CInP* event_ID
end
