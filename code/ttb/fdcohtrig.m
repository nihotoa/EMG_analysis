function varargout  = ftcohtrig(timeRange, ntrials, nfftPoints, movingStep, chan1, chan2, chantrig, trigWindows, chanref, opt_str)
% FDCOHTRIG Fast-dcohtrig (fast-series by TT)
% fdcohtrig(timeRange, ntrials, nfftPoints, movingStep, chan1, chan2, chantrig, trigWindows, chanref, opt_str)
%   timeRange -- time range in seconds e.g. [0 200.0]
%   ntrials -- total number of trials to use for analysis. Inf for no restriction. 
