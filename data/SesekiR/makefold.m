...
EMG_numlist = [12];
cd nmf_result
mkdir([monkeyname xpdate '_standard_filtNO5'])

cd([monkeyname xpdate '_standard_filtNO5'])
...
cd ../
cd([monkeyname xpdate '_standard'])
copyfile([monkeyname xpdate '_standard.mat'],[monkeyname xpdate '_standard_filtNO5_' sprintf('%02d',EMG_numlist(i)) '.mat'])
copyfile(['t_' monkeyname xpdate '_standard.mat'],[monkeyname xpdate '_standard_filtNO5_' sprintf('%02d',EMG_numlist(i)) '_nmf.mat'])
cd ../../