...
%
% you will see a lot of lines with error messages -- this is expected
% since verification script calls all mexPlex methods with valid 
% as well as invalid parameters.
