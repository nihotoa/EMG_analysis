function [data, text, rawData]=xlsread(file,sheet,range,mode,customFun)
...
%   $Revision: 1.23.4.17 $  $Date: 2005/06/21 19:35:44 $
%=============================================================================
...
%             keyboard
            ...
            % 武井によって変更　ダイアログの文字列はrangeによって定義できます
