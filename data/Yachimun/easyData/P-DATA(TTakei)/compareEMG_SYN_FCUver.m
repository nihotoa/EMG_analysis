...
%       load('XcorrFingerM_80_190731analyzed_trig2.mat');
      load('XcorrSyn_80_Range1_trig1.mat');
      load('XcorrFingerM_80_Range1_trig1_FCUver.mat');
end
fingerM = {'FCU','FDSdist','EDCdist','ED23'};
              ...
              case 'RAW'
                 switch Tar
                    case 'All'
                       ...
                       elseif j==2
                          plot(xdays,FCU_A(:,1),'Color',c1(1,:),'LineWidth',1.5);
...
%                           plot(xdays,[EDCdist_A(1:28,3); EDCdist_A(30:81,3)],'o-','Color',c1(9,:),'LineWidth',1.3);
                       ...
                       elseif j==2
                          FCU_A =FCU_A';
                          FDSdist_A= FDSdist_A';
%                           plot(xdays,[FCU_A(1:28,1); FCU_A(30:81,1)],'Color',c1(1,:),'LineWidth',1.3);
...
%            end
      ...
      Title = {'Extensor','Flexor'};
          ...
          elseif j==2
             L = legend({'Control','FCU','FDSdist','Synergy1','Task Disable'},'Location','southwest');
          end
           set(L,...
