...
h1  = uicontrol(fig,'BackgroundColor',[1 1 1],...
   ...
   'Min',1,...
   'String','',...
   'Callback','s=get(gcf,''UserData'');ind = get(gco,''Value''); filenames   = get(gco,''String'');s.selectedfile =filenames{ind};viewcumdens([s.parentpath,''\'',s.selectedfile]);set(gcf,''UserData'',s)');
