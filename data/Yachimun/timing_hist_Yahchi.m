...
load([monkeyname xpdate '-' sprintf('%04d', file_num(1,1)) '.mat'], 'CInPort_001*');
    ...
    for i=1:suc_num
        ...
        if Timing(2,suc_i - 4)==49664 && Timing(2,suc_i - 3)==2560 && Timing(2,suc_i - 2)==35328 && ...
            Timing(2,suc_i - 1)==18944
