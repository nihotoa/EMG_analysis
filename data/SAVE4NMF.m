...
function:
merge & create one-day EMG data (with resampling(5000Hz)) & save individual
muscle data as '(uv).mat' 
(データをマージして（ここはrunnningEasyfuncと一緒）、個々の筋肉をそれぞれ.matファイルで保存する)
※ saved dir is monkeyname → nmf_result → '_standard' folder
【procedure】
pre:SaveFileInfo
...
for s = 1:session_num
   ...
   %↑merge experiment data and save as individual file
