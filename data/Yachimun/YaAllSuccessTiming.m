function [] = YaAllSuccessTiming(xpdate,file_num)
...
load([monkeyname xpdate '-' sprintf('%04d', file_num(1,1)) '.mat'], 'CInPort_001*');
    ...
    for i=1:suc_num
        if T_timing(i,1)~=0
            ...
            if 0<time_w1 && time_w1<(10000000000000000) 
...
%     cd ../
    cd AllSuccessTiming
        save([monkeyname xpdate '_SUC_tim_per.mat'],'SUC_tim_per','SUC_Timing_A','file_num');
